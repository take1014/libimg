...
img_malloc_array(int Height, int Width){
...
img_read(char *InputFileName, img_struct *img){
   ...
   img->r = img_malloc_array(img->Height, img->Width);
   img->g = img_malloc_array(img->Height, img->Width);
   img->b = img_malloc_array(img->Height, img->Width);
